...
class AllisonAndAndrew extends Component {
    state = {
        giftList: [],
    };
    ...
    loadGifts() {
        API.getGifts()
            ...
            .then(res => {
                const newArr = res.data.filter(e => e.couple === "Allison and Andrew");
                this.setState({
                    giftList: newArr
                })
            }
        ...
        return (
            <div>
                ...
                <Container>
                    <Row>
                        <Col size="s12">
                        <h3 className="center">Allison and Andrew</h3>
...
export default AllisonAndAndrew;