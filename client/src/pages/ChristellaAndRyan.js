...
class ChristellaAndRyan extends Component {
    state = {
        giftList: [],
    };
    ...
    loadGifts() {
        API.getGifts()
            .then(res => {
                const newArr = res.data.filter(e => e.couple === "Christella and Ryan");
                this.setState({
                    giftList: newArr
                });
        ...
        return (
            <div>
                ...
                <Container>
                    <Row>
                        <Col size="s12">
                            <h3 className="center">Christella and Ryan</h3>
...
export default ChristellaAndRyan;