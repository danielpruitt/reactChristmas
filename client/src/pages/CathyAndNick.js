...
class CathyAndNick extends Component {
    state = {
        giftList: [],
    };
    ...
    loadGifts() {
        API.getGifts()
            .then(res => {
                const newArr = res.data.filter(e => e.couple === "Cathy and Nick");
                this.setState({
                    giftList: newArr
                });
        ...
        return (
            <div>
                ...
                <Container>
                    <Row>
                        <Col size="s12">
                            <h3 className="center">Cathy and Nick</h3>
