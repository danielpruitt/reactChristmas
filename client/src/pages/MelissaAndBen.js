...
class MelissaAndBen extends Component {
    state = {
        giftList: [],
    };
    ...
    loadGifts() {
        API.getGifts()
            ...
            .then(res => {
                const newArr = res.data.filter(e => e.couple === "Melissa and Ben");
                this.setState({
                    giftList: newArr
                })
            }
        ...
        return (
            <div>
                ...
                <Container>
                    <Row>
                        <Col size="s12">
                        <h3 className="center">Melissa and Ben</h3>
